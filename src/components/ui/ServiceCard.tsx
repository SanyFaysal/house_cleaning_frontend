...
export default function ServiceCard({ service }: { service: IService }) {
    ...
    return (
        <div onClick={() => router.push(`service/service-details/${service?.id}`)} className=" hover:shadow-lg duration-200  cursor-pointer rounded-lg bg-white">
            <img src={service?.image} className="rounded-t-lg h-[25vh]  border-0 w-full" alt="" />
            <div className="px-2 py-3 mb-4">
                <h5 className="text-xl font-medium tracking-tight pb-3 pl-2 text-gray-900 dark:text-white">
